...
var addLoggingToDispatchES6 = function addLoggingToDispatchES6(store) {
  return function (next) {
    return function (action) {
      console.log(store.getState());
      console.log(action);
...
var configureStore = function configureStore() {
  ...
  var store = (0, _redux.createStore)(_root_reducer2.default, preloadedState, (0, _redux.applyMiddleware)(addLoggingToDispatchES6));
