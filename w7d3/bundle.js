...
var configStore = exports.configStore = (0, _redux.createStore)(_root_reducer2.default, (0, _redux.applyMiddleware)(_reduxThunk2.default));
...
exports.default = function (_ref) {
  ...
  var giphyItems = giphys.map(function (giphy, index) {
    return _react2.default.createElement(_giphys_index_item2.default, { key: index, giphy: giphy });
  });
...
var GiphysSearch = function (_React$Component) {
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function click(e) {
      e.preventDefault();
      var validSearch = this.state.searchTerms.split(' ').join('+');
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            null,
            'Search',
            _react2.default.createElement('input', { type: 'text', onChange: this.updateSearch, value: this.state.searchTerms })
          ),
